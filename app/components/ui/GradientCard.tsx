...
const GRADIENT_COLORS = [
  'from-blue-600/10 to-blue-500/5',
  ...
  'from-pink-500/10 to-blue-600/5',
];
  ...
  return (
    <motion.div
      className={classNames(
        ...
        gradientClass,
        borderEffect
          ? 'border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor-dark hover:border-blue-500/40'
          : '',
