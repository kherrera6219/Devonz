    ...
    return (
        <div className="relative">
            ...
            <button
                ...
                className={`w-full flex items-center justify-between gap-2 px-2 py-1.5 text-xs font-medium rounded border transition-colors ${isBulkMode
                        ...
                        <div key={category.category}>
                            ...
                            {category.targets.map((target) => (
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-1.5 text-xs hover:bg-bolt-elements-background-depth-3 transition-colors ${selectedTarget?.value === target.value || (target.value === 'current' && !selectedTarget)
                    ...
                    {currentTagName && !['html', 'body', 'head'].includes(currentTagName.toLowerCase()) && (
                        <div>
                            ...
                            <button
                                ...
                                className={`w-full text-left px-3 py-1.5 text-xs hover:bg-bolt-elements-background-depth-3 transition-colors ${selectedTarget?.value === 'same-tag'
                                        ? 'bg-accent-500/20 text-accent-400'
                                        : 'text-bolt-elements-textPrimary'
                                    }`}
                            >
