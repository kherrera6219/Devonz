...
??? question "What are the best models for Devonz?"
For the best experience with Devonz, we recommend using the following models from our 19 supported providers:
...
Devonz uses a modular provider architecture. To add a new provider:
...
Devonz provides multiple ways to access help and documentation:
...
??? question "How do I get the best results with Devonz?"
...
MCP extends Devonz's AI capabilities with external tools:
...
??? question "How do I deploy my Devonz projects?"
Devonz supports one-click deployment to multiple platforms:
...
Devonz provides comprehensive Git and GitHub integration:
...
??? question "How do I contribute to Devonz?"
Check out our [Contribution Guide](CONTRIBUTING.md) for more details on how to get involved!

??? question "What are the future plans for Devonz?"
Visit our [Roadmap](https://roadmap.sh/r/ottodev-roadmap-2ovzo) for the latest updates.  
 New features and improvements are on the way!

??? question "Why are there so many open issues/pull requests?"
Devonz began as a small showcase project on @ColeMedin's YouTube channel to explore editing open-source projects with local LLMs. However, it quickly grew into a massive community effort!

    We're forming a team of maintainers to manage demand and streamline issue resolution. The maintainers are rockstars, and we're also exploring partnerships to help the project thrive.

## New Features & Technologies

??? question "What's new in Devonz?"
Recent major additions to Devonz include:
...
Devonz offers templates for popular frameworks and technologies:
...
??? question "How do local LLMs compare to larger models like Claude 3.5 Sonnet for Devonz?"
...
If you're having trouble with MCP integrations:
    ...
    - **Test server connectivity** outside of Devonz
...
**Windows development environment**: Install Visual Studio C++ (version 14.40.33816 or later). More details in [GitHub Issues](https://github.com/zebbern/Devonz/issues/19)
...
[Join the Devonz Community](https://thinktank.ottomator.ai/c/bolt-diy/17){target=\_blank} for discussions and help

!!! bug "Report Issues"
[Open an Issue](https://github.com/zebbern/Devonz/issues){target=\_blank} in our GitHub Repository
